...
export default function ClothingProduct() {
  ...
  const similarProducts = product ? Clothing.filter(item => 
    item.id !== product.id
  ).slice(0, 4) : []
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between mt-16">
          <Link to="/clothing" className="flex items-center gap-2 text-sm hover:underline">
